...
/**
*/
class ParametricSpringReverbAudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    ParametricSpringReverbAudioProcessor();
    ~ParametricSpringReverbAudioProcessor() override;
