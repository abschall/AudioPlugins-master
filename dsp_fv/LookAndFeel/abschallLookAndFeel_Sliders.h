// pragma once ensures that this header file is included only once in the compilation process
...
public:
    ...
    private:
        juce::Colour titleLabelColour = juce::Colours::green; 
...
public:
    ...
    juce::Colour fontLabelColour = juce::Colours::white; // Default color for valueLabel
private:
...
{
public:
    // Constructor for abschallLookAndFeel_Sliders
